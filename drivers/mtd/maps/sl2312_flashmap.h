...
static struct mtd_partition sl2312_partitions[] = {
        ...
        { name: "Ramdisk", offset: 0x00220000, size: 0x00400000, },
        { name: "Application", offset: 0x00620000, size: 0x00180000, },
        { name: "VCTL", offset: 0x007A0000, size: 0x20000, },
        { name: "CurConf", offset: 0x007C0000, size: 0x20000, },
        { name: "FIS directory", offset: 0x007E0000, size: 0x00020000, },
        { name: "MAC backup", offset: 0x00FE0000, size: 0x20000, }
};
