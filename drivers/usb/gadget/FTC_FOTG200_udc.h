...
//#define USB_DBG 	(DBG_FUNC|DBG_CTRL) //stone 0914 OK.
//#define USB_DBG 	(DBG_CTRL)
...
//        #define mdwOTGC_INT_STS_Rd()                      (wFOTGPeri_Port(0x84))
//        #define mdwOTGC_INT_STS_Clr(wValue)               (wFOTGPeri_Port(0x84) |= wValue)    
