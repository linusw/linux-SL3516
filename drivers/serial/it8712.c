...
//Sunny 20070307 use the name of SOC UART 
//#define SERIAL_IT8712_NAME	"ttySI"
#define SERIAL_IT8712_NAME	"ttySL" //Sunny. use the name of SOC UART 
#define SERIAL_IT8712_MAJOR	204
//Sunny 20070307 use the MINOR of SOC UART 
//#define SERIAL_IT8712_MINOR	41      /* Temporary - will change in future */
#define SERIAL_IT8712_MINOR	40      /* Temporary - will change in future */
...
static void EnterPnP(void)
{
        WRITE_UINT8(LPC_KEY_ADDR, 0x87);
        WRITE_UINT8(LPC_KEY_ADDR, 0x87);
}

static void ExitPnP(void)
{
...
static int __init it8712_console_setup(struct console *co, char *options)
{
	...
	//Sunny 20070307 begin
	EnterPnP();
        SelectLD(0x02);
        ConfigPnP(0x30, 0x01);
        ConfigPnP(0x60, 0x03);
        ConfigPnP(0x61, 0xf8);
	base = IT8712_IO_BASE + 0x3f8;
	ExitPnP();
