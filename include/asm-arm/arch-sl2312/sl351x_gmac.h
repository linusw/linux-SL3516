...
#define GMAC_DEBUG      			1
#define GMAC_NUM					2
//#define       L2_jumbo_frame                          1	/* 2007.08.08 Neagus for Jumbo Frame */
...
extern unsigned short max_jumbo_frame_size;
#define SW_RX_BUF_SIZE		(max_jumbo_frame_size + 14 + SKB_RESERVE_BYTES + RX_INSERT_BYTES)
#else
...
#define GMAC_DEV_TX_TIMEOUT  		(1*(HZ/100))	//(1*HZ)	//add by CH
 ...
 **********************************************************************/
#define TOE_SW_FREEQ_DESC_POWER		12 //10 
...
#define TOE_GMAC0_SWTXQ_DESC_POWER	10 //9
...
#define TOE_GMAC1_SWTXQ_DESC_POWER	10 //9
...
#define TOE_DEFAULT_Q0_DESC_POWER	10 //9
#define TOE_DEFAULT_Q0_DESC_NUM		(1<<TOE_DEFAULT_Q0_DESC_POWER)
#define TOE_DEFAULT_Q1_DESC_POWER	10 //9
...
typedef union
{
	...
	struct bit_8070
	{
		...
		unsigned int	reserved1	: 1;	// bit 30:27	
