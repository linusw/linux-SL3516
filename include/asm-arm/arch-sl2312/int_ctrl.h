...
#define	IRQ_PCI_D_MASK                 	(1<<29)
#define	IRQ_PCI_C_MASK                 	(1<<28)
#define	IRQ_PCI_B_MASK                 	(1<<27)
...
#else
#define	IRQ_PCI_D_OFFSET                 	29
#define	IRQ_PCI_C_OFFSET                 	28
#define	IRQ_PCI_B_OFFSET                 	27
#define IRQ_PWR_OFFSET				    	26
#define IRQ_CIR_OFFSET						25
#define	IRQ_GPIO2_OFFSET                   	24
#define	IRQ_GPIO1_OFFSET                   	23
